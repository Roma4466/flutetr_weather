...
**❗ In order to start using Weather Api Client you must have the [Dart SDK][dart_install_link]
installed on your machine.**

Add `weather_api_client` to your `pubspec.yaml`:
...
Weather Api Client comes with a built-in [GitHub Actions workflow][github_actions_link] powered
